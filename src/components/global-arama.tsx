...
const KONULAR: { baslik: string; sayfa: string; sekme?: string; hedef: string }[] = [
  ...
  { baslik: "Tahmin", sayfa: "İhale günü", sekme: "Tahmin", hedef: "/dashboard/ihale-gunu" },
  { baslik: "Emirlerim", sayfa: "İhale günü", sekme: "Emirlerim", hedef: "/dashboard/ihale-gunu" },
  { baslik: "İhale sonrası performans", sayfa: "İhale günü", sekme: "İhale sonrası performans", hedef: "/dashboard/ihale-gunu" },

  { baslik: "İhale geçmişi", sayfa: "DİBS Detay", sekme: "DİBS Detay", hedef: "/dashboard/dibs-detay" },
  { baslik: "BIST ikincil piyasa fiyatı", sayfa: "DİBS Detay", sekme: "DİBS Detay", hedef: "/dashboard/dibs-detay" },
  { baslik: "Düzenli İşlem Gören", sayfa: "DİBS Detay", sekme: "Düzenli İşlem Gören", hedef: "/dashboard/dibs-detay" },
  { baslik: "Karşılaştır", sayfa: "DİBS Detay", sekme: "Karşılaştır", hedef: "/dashboard/dibs-detay" },
  ...
  { baslik: "DİBS piyasa değeri", sayfa: "TCMB", sekme: "DİBS Piyasa Değeri", hedef: "/dashboard/tcmb" },
  { baslik: "TCMB APİ Portföyü", sayfa: "TCMB", sekme: "TCMB APİ Portföyü", hedef: "/dashboard/tcmb" },
  { baslik: "TÜFE, M2, KFE ve Bono", sayfa: "TCMB", sekme: "TÜFE, M2, KFE ve Bono", hedef: "/dashboard/tcmb" },
  { baslik: "Repo faiz koridoru", sayfa: "TCMB", sekme: "Repo Faiz Koridoru", hedef: "/dashboard/tcmb" },
  { baslik: "TLREF", sayfa: "TCMB", sekme: "TLREF", hedef: "/dashboard/tcmb" },
  { baslik: "Dış denge", sayfa: "TCMB", sekme: "Dış Denge", hedef: "/dashboard/tcmb" },
  { baslik: "Net Rezerv", sayfa: "TCMB", sekme: "Net Rezerv", hedef: "/dashboard/tcmb" },
  { baslik: "Piyasa beklentileri", sayfa: "TCMB", sekme: "Piyasa Beklentileri", hedef: "/dashboard/tcmb" },
  { baslik: "PPK karar farkı", sayfa: "TCMB", sekme: "PPK Karar Farkı", hedef: "/dashboard/tcmb" },
  { baslik: "Enflasyon Raporu", sayfa: "TCMB", sekme: "Enflasyon Raporu", hedef: "/dashboard/tcmb" },

  { baslik: "Merkezi Yönetim Borç Stoku", sayfa: "Hazine", sekme: "Borç Stoku / Nakit", hedef: "/dashboard/hazine" },
  { baslik: "Hazine Nakit Gerçekleşmeleri", sayfa: "Hazine", sekme: "Borç Stoku / Nakit", hedef: "/dashboard/hazine" },
  { baslik: "İç Borç Çevirme Oranı", sayfa: "Hazine", sekme: "İç Borç Çevirme Oranı", hedef: "/dashboard/hazine" },
  { baslik: "Ortalama Vade / Maliyet", sayfa: "Hazine", sekme: "Ortalama Vade / Maliyet", hedef: "/dashboard/hazine" },
  { baslik: "İç Borçlanmanın Ortalama Vadesi / Maliyeti", sayfa: "Hazine", sekme: "Ortalama Vade / Maliyet", hedef: "/dashboard/hazine" },

  { baslik: "Gecelik (O/N)", sayfa: "TPP", sekme: "Gecelik (O/N)", hedef: "/dashboard/takasbank-tpp" },
  { baslik: "Vade Yapısı", sayfa: "TPP", sekme: "Vade Yapısı", hedef: "/dashboard/takasbank-tpp" },

  { baslik: "Günlük işlemler", sayfa: "Özel sektör tahvilleri", sekme: "Günlük işlemler", hedef: "/dashboard/ozel-sektor" },
  { baslik: "İhraççı profili", sayfa: "Özel sektör tahvilleri", sekme: "İhraççı profili", hedef: "/dashboard/ozel-sektor" },
